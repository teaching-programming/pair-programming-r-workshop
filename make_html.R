...
assemble_whole_page <- function(){
  ...
  exercises_html <- append(exercises_html, exercise_html("Exercise 1.5: Unit conversion", "exercise1.5" ))
  ...
  exercises_html <- append(exercises_html, exercise_html("Exercise 2.3: Functions", "exercise2.2" ))
